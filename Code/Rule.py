...
def ruletext (page,text_font_bold,text_font_regular) :
    #Components Text render 
        ...
        #Game Play 1 / 2
        if page == 8 :
            text_block(text_font_bold , "Game Play 1/2", 'Black', (550,150), 1030, screen, 10)
            text_block(text_font_regular, Textpage (page), 'Black', (270,230), 1030, screen, 15)
        #Game Play 2 / 2
        if page == 9 :
            text_block(text_font_bold , "Game Play 2/2", 'Black', (550,150), 1030, screen, 10)
            text_block(text_font_regular, Textpage (page), 'Black', (270,230), 1030, screen, 15)
        #Selecting Tokens
        if page == 10 :
        ...
        #The Bonuses 1 / 2
        if page == 16 :
            text_block(text_font_bold , "The Bonuses 1/2", 'Black', (550,150), 1030, screen, 10)
            text_block(text_font_regular, Textpage (page), 'Black', (270,230), 1030, screen, 15)
        #The Bonuses 2 / 2
        if page == 17 :
            text_block(text_font_bold , "The Bonuses 2/2", 'Black', (550,150), 1030, screen, 10)
            text_block(text_font_regular, Textpage (page), 'Black', (270,230), 1030, screen, 15)
        #The Nobles 1 / 2
        if page == 18 :
            text_block(text_font_bold , "The Nobles 1/2", 'Black', (550,150), 1030, screen, 10)
            text_block(text_font_regular, Textpage (page), 'Black', (270,230), 1030, screen, 15)
        #The Nobles 2 / 2
        if page == 19 :
            text_block(text_font_bold , "The Nobles 2/2", 'Black', (550,150), 1030, screen, 10)
            text_block(text_font_regular, Textpage (page), 'Black', (270,230), 1030, screen, 15)
        #End of the Game 
        if page == 20 :
